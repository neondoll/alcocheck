...
<div class="site-contact">
    ...
    <?php if (Yii::$app->session->hasFlash('contactFormSubmitted')): ?>
        ...
        <p>
            Note that if you turn on the Yii debugger, you should be able to view the mail message on the mail panel of
            the debugger.
            <?php if (Yii::$app->mailer->useFileTransport): ?>
                ...
                <code>useFileTransport</code> property of the <code>mail</code> application component to be false to
